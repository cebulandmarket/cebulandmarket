...
var LISTINGS_DATA = [
  ...
  },
  {
    ...
    "description": "Tucked inside Holy Family Village 2 — a quiet, gated subdivision in Banilad with 24/7 security, tree-lined streets, a swimming pool, and a playground. It's peaceful inside, but step outside and everything is within reach: Banilad Town Centre is a 3-minute walk, IT Park is 5 minutes away, Ayala Center Cebu is a short drive. Hospitals, schools, restaurants, banks — all right here. 2-storey home with 3 bedrooms, 2 bathrooms, and 2-car parking. The dining table is included — the rest of the furniture shown in the photos is not. Currently rented at ₱50,000/month — a proven income property. This is city living without the noise — the kind of neighborhood where mornings are calm, streets are safe, and you never have to go far for anything.",
    "features": "3 Bedrooms,2 Bathrooms,2-Storey,2-Car Parking,Dining Table Included,Clean Title,1 Owner,85 sqm Lot,100 sqm Floor Area",
