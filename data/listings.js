...
var LISTINGS_DATA = [
  {
    ...
    "vision_items": "A Quiet Mountain Retreat|Small cottages along the slope, each one with its own view. Somewhere people come to rest, not to be entertained. The terrain was made for this.|A Yoga Shala & Meditation Space|An open-air yoga shala on the hillside, an open-space kubo for meditation. Cool breeze, fresh mountain air, nothing but nature around you. This is the kind of place people travel far to find.|Livestock Farming|The land is spacious, sloping, and has water and electricity connected — ideal for raising goats, chickens, or cattle. The cooler climate up here is better for animals, and the natural vegetation keeps feed costs low.|A Place to Build a Life|1.5 hectares is a lot of space. A house here, a garden there, room for family. It's the kind of land you can grow into over years."
  }
];
