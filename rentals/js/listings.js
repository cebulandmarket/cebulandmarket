...
function renderPropertyDetail() {
  ...
  fetchListings(function(listings) {
    ...
    // Gate contact buttons until inquiry form is submitted (skip for rented)
    if (!rented) {
  ...
  if (!document.getElementById('inquiryRegModal')) {
    ...
    modal.innerHTML =
      '<div class="inquiry-modal-content">' +
        ...
        '<p class="inquiry-subtitle">Rental: <strong>' + escapeHtml(info.title) + '</strong> (' + info.code + ')</p>' +
...
function submitInquiryRegistration(e) {
  ...
  fd.append('from_name', 'CebuRentMarket Inquiry');
