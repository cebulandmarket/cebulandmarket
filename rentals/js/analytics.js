...
var GC_CODE = 'ceburentmarket';

// Admin key (lightly obfuscated — not in plain text)
var ADMIN_KEY = atob('Y3JtMjAyNQ==');
    ...
    panel.innerHTML =
      '<div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">' +
        '<div style="display:flex; gap:24px; flex-wrap:wrap;">' +
          '<span>Total Views: <strong style="color:#7B1FA2; font-size:16px;">' + stats.totalViews + '</strong></span>' +
          '<span>Active Days: <strong style="color:#7B1FA2;">' + stats.uniqueDays.length + '</strong></span>' +
        ...
        '<div>' +
          ...
          (GC_CODE !== 'YOUR_GOATCOUNTER_CODE'
            ? '<a href="https://' + GC_CODE + '.goatcounter.com" target="_blank" style="color:#7B1FA2; text-decoration:underline; margin-right:12px;">Full Dashboard</a>'
            : '') +
